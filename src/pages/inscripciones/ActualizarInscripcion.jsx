        ...
        <div className="flew flex-col w-full h-full items-center justify-center p-10">
          ...
          >
            ...
            <Input
              ...
              defaultValue={
                dataInscripcion.consultarInscripcionPorId[0].fechaInscripcion
              }
              required={true}
              isDisabled={true}
            />
            <Input
              ...
              name="fechaIngreso"
              defaultValue={
                dataInscripcion.consultarInscripcionPorId[0].fechaIngreso
                  ? dataInscripcion.consultarInscripcionPorId[0].fechaIngreso
            ...
            <Input
              ...
              name="fechaEgreso"
              defaultValue={
                dataInscripcion.consultarInscripcionPorId[0].fechaEgreso
                  ? dataInscripcion.consultarInscripcionPorId.fechaEgreso
            ...
            <Input
              ...
              name="proyecto"
              defaultValue={
                dataInscripcion.consultarInscripcionPorId[0].proyecto.nombre
              }
              required={true}
              isDisabled={true}
            />
            <Input
              ...
              defaultValue={
                dataInscripcion.consultarInscripcionPorId[0].estudiante.nombre
              }
              required={true}
              isDisabled={true}
            />
            <Input
              ...
              defaultValue={
                dataInscripcion.consultarInscripcionPorId[0].estudiante.apellido
              }
              required={true}
              isDisabled={true}
            />
