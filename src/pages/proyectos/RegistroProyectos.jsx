        ...
        {userData.rol == "LIDER" ? (
          <div class="w-3/5">
            <div class="text-gray-700">
              ...
              <input
                class="w-full h-10 px-3 text-base bg-light-brown placeholder-gray-600 border rounded-lg focus:shadow-outline"
                type="text"
                name="nombre"
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <i
        ...
        className="fas fa-minus rounded-full bg-red-500 hover:bg-red-400 text-white p-2 mx-2 mt-9 mb-3 cursor-pointer"
      ></i>
    </div>
  );
};
